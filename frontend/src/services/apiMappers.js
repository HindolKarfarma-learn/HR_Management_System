...
export function toUserUpdate(values) {
  ...
  return {
    ...
    ...(values.emergencyContact && {
      emergency_contact_name: values.emergencyContact.name || null,
      emergency_contact_relationship: values.emergencyContact.relationship || null,
      emergency_contact_phone: values.emergencyContact.phone || null,
    }),
  };
}
