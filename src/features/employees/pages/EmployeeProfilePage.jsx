  ...
  return (
    <>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <Card><CardHeader title="Personal details" /><CardContent className="grid gap-5 sm:grid-cols-2"><Detail label="Employee ID" value={employee.id} /><Detail label="Date of birth" value={dayjs(employee.birthDate).format('DD MMM YYYY')} /><Detail label="Gender" value={employee.gender} /><Detail label="Address" value={employee.address} /></CardContent></Card>
